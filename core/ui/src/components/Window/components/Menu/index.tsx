    ...
    <>
      <MenuOpen open={open}>
          ...
          {programs &&
            programs.map((program) => (
              <ProgramIcon
                ...
                onMouseEnter={() => setFocusProgram(program)}
                icon={program.ProgramIcon}
                onMouseLeave={() => setFocusProgram(undefined)}
        ...
        <ExplicationProgramIcon
          ...
          title={focusProgram?.TitleExplication}
          icon={focusProgram?.ExplicationProgramIcon}
          text={focusProgram?.ExplicationProgramText}
        />
      </MenuOpen>
      <Container>
